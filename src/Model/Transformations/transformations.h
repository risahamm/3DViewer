...
namespace s21 {
   ...
   *
   * @note Конструктор принимает указатель на объект типа s21::Object, который
   *       будет модифицироваться. Если указатель не передан, он инициализируется
   *       значением nullptr.
   */
   ...
   * модифицироваться. Если параметр не задан, он инициализируется значением
   * nullptr.
