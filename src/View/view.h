...
class View : public QMainWindow {
 ...
 public:
  ...
  struct Settings {
    View::Projection
        projection;  ///< тип проекции (ортографическая или перспективная)
 ...
 private slots:
  ...
  /**
   * @brief Обрабатывает отпускание кнопки "Move Left".
   * @details Останавливает таймер и отключает сигнал таймера от метода
   * перемещения влево.
   */
  ...
  /**
   * @brief Поворачивает вид влево на заданный угол.
   * @details Вызывает функцию контроллера RoateYLeft, чтобы повернуть
   * вид на 5 градусов влево.
   */
  void RotateLeft();

  /**
   * @brief Обрабатывает отпускание кнопки "Rotate Left".
   * @details Останавливает таймер и отключает сигнал таймера от метода
   * вращения влево.
   */
  ...
  /**
   * @brief Поворачивает вид вправо на заданный угол.
   * @details Вызывает функцию контроллера RoateYRight, чтобы повернуть
   * вид на 5 градусов вправо.
   */
  void RotateRight();

  /**
   * @brief Обрабатывает отпускание кнопки "Rotate Right".
   * @details Останавливает таймер и отключает сигнал таймера от метода
   * вращения вправо.
   */
  ...
  /**
   * @brief Поворачивает вид вверх на заданный угол.
   * @details Вызывает функцию контроллера RoateXUp, чтобы повернуть
   * вид на 5 градусов вверх.
   */
  void RotateUp();

  /**
   * @brief Обрабатывает отпускание кнопки "Rotate Up".
   * @details Останавливает таймер и отключает сигнал таймера от метода
   * вращения вверх.
   */
  ...
  /**
   * @brief Поворачивает вид вниз на заданный угол.
   * @details Вызывает функцию контроллера RoateXDown, чтобы повернуть
   * вид на 5 градусов вниз.
   */
  void RotateDown();

  /**
   * @brief Обрабатывает отпускание кнопки "Rotate Down".
   * @details Останавливает таймер и отключает сигнал таймера от метода
   * вращения вниз.
   */
  ...
  /**
   * @brief Поворачивает вид на заданный угол по часовой стрелке.
   * @details Вызывает функцию контроллера RoateZClckWs, чтобы повернуть
   * вид на 5 градусов по часовой стрелке.
   */
  void RotateClckWise();

  /**
   * @brief Обрабатывает отпускание кнопки "Rotate Clockwise".
   * @details Останавливает таймер и отключает сигнал таймера от метода
  ...
  /**
   * @brief Поворачивает вид на заданный угол против часовой стрелки.
   * @details Вызывает функцию контроллера RoateZCClckWs, чтобы повернуть
   * вид на 5 градусов против часовой стрелки.
   */
  void RotateCClckWise();

  /**
   * @brief Обрабатывает отпускание кнопки "Rotate CounterClockwise".
   * @details Останавливает таймер и отключает сигнал таймера от метода
 ...
 private:
   ...
   * @details Метод загружает сохраненные настройки из объекта настроек
   * пользователя и применяет их к элементам интерфейса и текущим настройкам.
